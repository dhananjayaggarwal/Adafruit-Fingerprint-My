...
class Adafruit_Fingerprint {
 public:
  ...
  uint8_t downModel(uint8_t bufferNumber);
  void sendData(uint8_t type, uint8_t lengthOfData, uint8_t * dataPtr);
